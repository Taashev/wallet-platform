    ...
    >
      ...
      {name === 'settings' ? (
        <>
          ...
          <path d="m19.4 15 .9 1.5-1.8 3.1-1.8-.1-1 .9-.2 1.8h-3.6l-.2-1.8-1-.9-1.8.1-1.8-3.1.9-1.5V13l-.9-1.5 1.8-3.1 1.8.1 1-.9.2-1.8h3.6l.2 1.8 1 .9 1.8-.1 1.8 3.1-.9 1.5V15Z" />
        </>
      ) : null}
      {name === 'search' ? (
        <>
